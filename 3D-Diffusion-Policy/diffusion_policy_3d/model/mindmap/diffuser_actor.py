...
import einops
from diffusion_policy_3d.model.mindmap.timer import Timer
import torch
import torch.nn as nn

from diffusion_policy_3d.model.mindmap.data_types import DataType, includes_mesh, includes_pcd
from diffusion_policy_3d.model.mindmap.diffusion_head import DiffusionHead
from diffusion_policy_3d.model.mindmap.encoder import Encoder
from diffusion_policy_3d.model.mindmap.feature_types import FeatureExtractorType
from diffusion_policy_3d.model.mindmap.distributed import get_rank
from diffusion_policy_3d.model.mindmap.loss import LossWeights, compute_loss
from diffusion_policy_3d.model.mindmap.normalization import (
    normalize_pointcloud,
    normalize_pos,
    normalize_trajectory,
    unnormalize_trajectory,
)
from diffusion_policy_3d.model.mindmap.relative_conversions import (
...
from diffusion_policy_3d.model.mindmap.tensor_visualizer import TensorVisualizer
...
class DiffuserActor(nn.Module):
    def __init__(
        ...
        # Registered buffer: lands in state_dict, so checkpoints carry the bounds
        # the model was TRAINED with (like the normalizer) and eval restores them
        # automatically. Data-derived: set from the dataset via
        # MindmapDP3.set_workspace_bounds at training start; all-zeros means unset.
        self.register_buffer(
            "workspace_bounds",
            torch.zeros(2, 3, dtype=torch.float32)
            if workspace_bounds is None
            else torch.as_tensor(workspace_bounds, dtype=torch.float32),
        )
